...
if grep $ROS_WORKSPACE /home/ros_entrypoint.sh; then
    echo "workspace $ROS_WORKSPACE was already set to be sourced on startup:"
else
    tac /home/ros_entrypoint.sh | sed -e "3iros_source_env $ROS_WORKSPACE/install/setup.bash" | tac | tee /home/ros_entrypoint.sh
